...
class MapManagerTest extends \PHPUnit\Framework\TestCase
{
...
//    use TestCaseTrait;
    ...
    public function setUp(): void
    {
        ...
        shell_exec('cat lib/Weathermap/Tests/weathermap-seed.sql | mysql weathermaptest;');
    ...
    public function tearDown(): void
    {
        ...
        self::$pdo->exec('TRUNCATE `weathermap_maps`');
        self::$pdo->exec('TRUNCATE `weathermap_data`');
        self::$pdo->exec('TRUNCATE `weathermap_auth`');
        self::$pdo->exec('TRUNCATE `weathermap_groups`');
        self::$pdo->exec('TRUNCATE `weathermap_settings`');
        self::$pdo->exec('TRUNCATE `settings`');
        self::$pdo->exec('TRUNCATE `user_auth`');
        self::$pdo->exec('TRUNCATE `user_auth_perms`');
        self::$pdo->exec('TRUNCATE `user_auth_realm`');
